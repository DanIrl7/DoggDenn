export default function ContactPage() {
  return (
    <main className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="bg-foreground text-foreground py-20 px-6">
      ...
      <section className="py-16 bg-[#78350F]  w-full px-9 mx-auto">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="mb-8">
              ...
              <p className="text-white">
                <a href="mailto:info@doggdenn.com" className="hover:text-primary transition-colors">
                  info@doggdenn.com
                </a>
              </p>
            </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm">
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-primary-foreground font-bold py-3 rounded-full hover:opacity-90 transition-opacity duration-200"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300">
              <h3 className="text-lg font-bold text-primary mb-2">How long does shipping take?</h3>
              <p className="text-gray-600">
                Most orders ship within 1-2 business days. Delivery typically takes 3-5 business days depending on your location.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300">
              <h3 className="text-lg font-bold text-primary mb-2">Do you offer returns?</h3>
              <p className="text-gray-600">
                Yes! We offer a 30-day return policy on most items. Contact us if you&#39;re not satisfied with your purchase.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300">
              <h3 className="text-lg font-bold text-primary mb-2">Are your products pet-safe?</h3>
              <p className="text-gray-600">
